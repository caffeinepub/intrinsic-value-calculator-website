import { calculateActualValue, calculateIntrinsicPrice } from "./calculations";
import { type DcfInputs, VERIFICATION_INPUTS } from "./presets";
 ...
 */
export function runDevCheck(
  inputs: DcfInputs = VERIFICATION_INPUTS,
): DevCheckResult {
