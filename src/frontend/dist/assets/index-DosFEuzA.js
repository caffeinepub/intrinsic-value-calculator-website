...
const Calculator = createLucideIcon("calculator", __iconNode$d);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function CalculatorActions({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: onUseExample, variant: "outline", size: "sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-4 w-4 mr-2" }),
      "Use Example"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: onReset, variant: "outline", size: "sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(RotateCcw, { className: "h-4 w-4 mr-2" }),
      "Reset"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: handleCopyLink, variant: "outline", size: "sm", children: [
...
function CompanyInfoDisplay({ inputs }) {
  const hasData = inputs.shareName || inputs.marketCap || inputs.ltp || inputs.revenueLastYear || inputs.netProfitLastYear;
  if (!hasData) {
    return null;
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-gradient-to-br from-primary/5 to-accent/5 border-primary/20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4", children: [
        inputs.shareName && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Building2, { className: "h-4 w-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Share Name" })
        ] }) }),
        inputs.marketCap !== null && inputs.marketCap !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChartColumn, { className: "h-4 w-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Market Cap" })
        ] }) }),
        inputs.ltp !== null && inputs.ltp !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-4 w-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Last Traded Price" })
        ] }) }),
        inputs.revenueLastYear !== null && inputs.revenueLastYear !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DollarSign, { className: "h-4 w-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Revenue Last Year" })
        ] }) }),
        inputs.netProfitLastYear !== null && inputs.netProfitLastYear !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(PiggyBank, { className: "h-4 w-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Net Profit Last Year" })
        ] }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-4 pt-4 border-t", children: "Value in Cr." })
    ] })
  ] });
}
...
function validateInputs(inputs) {
  ...
  if (inputs.shareName.trim() !== "" && inputs.shareName.trim().length === 0) {
    errors.push({
      field: "shareName",
      message: "Share name cannot be only whitespace"
    });
  }
  ...
  if (inputs.ltp < 0) {
    errors.push({
      field: "ltp",
      message: "Last traded price cannot be negative"
    });
  }
  if (inputs.revenueLastYear < 0) {
    errors.push({
      field: "revenueLastYear",
      message: "Revenue last year cannot be negative"
    });
  }
  if (inputs.netProfitLastYear < 0) {
    errors.push({
      field: "netProfitLastYear",
      message: "Net profit last year cannot be negative"
    });
  }
  if (inputs.revenueLastQuarter < 0) {
    errors.push({
      field: "revenueLastQuarter",
      message: "Revenue last quarter cannot be negative"
    });
  }
  if (inputs.netProfitLastQuarter < 0) {
    errors.push({
      field: "netProfitLastQuarter",
      message: "Net profit last quarter cannot be negative"
    });
  }
  if (inputs.pbRatio < 0) {
  ...
  if (inputs.publicHolding < 0 || inputs.publicHolding > 1) {
    errors.push({
      field: "publicHolding",
      message: "Public holding must be between 0% and 100%"
    });
  }
  if (inputs.promoterPledgeQuantity < 0 || inputs.promoterPledgeQuantity > 1) {
    errors.push({
      field: "promoterPledgeQuantity",
      message: "Promoter pledge quantity must be between 0% and 100%"
    });
  }
  if (inputs.netNpaNbfc < 0 || inputs.netNpaNbfc > 1) {
    errors.push({
      field: "netNpaNbfc",
      message: "Net NPA (NBFC) must be between 0% and 100%"
    });
  }
  return errors;
}
function getFieldError(errors, field) {
  var _a2;
  return (_a2 = errors.find((e) => e.field === field)) == null ? void 0 : _a2.message;
}
...
function DcfInputsForm({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Company Snapshot" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Enter company and stock information" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "shareName", children: "Share Name" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "shareName",
        ...
        getFieldError(errors, "shareName") && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-destructive", children: getFieldError(errors, "shareName") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "marketCap", children: "Market Cap (₹)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "marketCap",
        ...
        getFieldError(errors, "marketCap") && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-destructive", children: getFieldError(errors, "marketCap") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "ltp", children: "Last Traded Price (₹)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "ltp",
        ...
        getFieldError(errors, "ltp") && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-destructive", children: getFieldError(errors, "ltp") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "revenueLastYear", children: "Revenue Last Year (₹)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "revenueLastYear",
        ...
        getFieldError(errors, "revenueLastYear") && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-destructive", children: getFieldError(errors, "revenueLastYear") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "netProfitLastYear", children: "Net Profit Last Year (₹)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
        ...
        getFieldError(errors, "netProfitLastYear") && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-destructive", children: getFieldError(errors, "netProfitLastYear") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "revenueLastQuarter", children: "Revenue Last Quarter (₹)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
        ...
        getFieldError(errors, "revenueLastQuarter") && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-destructive", children: getFieldError(errors, "revenueLastQuarter") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "netProfitLastQuarter", children: "Net Profit Last Quarter (₹)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
        ...
        getFieldError(errors, "netProfitLastQuarter") && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-destructive", children: getFieldError(errors, "netProfitLastQuarter") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "pbRatio", children: "P/B Ratio" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "pbRatio",
        ...
        getFieldError(errors, "pbRatio") && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-destructive", children: getFieldError(errors, "pbRatio") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "publicHolding", children: "Public Holding (%)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "publicHolding",
        ...
        getFieldError(errors, "publicHolding") && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-destructive", children: getFieldError(errors, "publicHolding") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "promoterPledgeQuantity", children: "Promoter Pledge Quantity (%)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
        ...
        getFieldError(errors, "promoterPledgeQuantity") && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-destructive", children: getFieldError(errors, "promoterPledgeQuantity") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Result Updated Since 6 Months" }),
          ...
          RadioGroup,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(RadioGroupItem, { value: "yes", id: "resultUpdated-yes" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Label,
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(RadioGroupItem, { value: "no", id: "resultUpdated-no" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Label,
                  {
        ...
        getFieldError(errors, "resultUpdatedSince6Years") && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-destructive", children: getFieldError(errors, "resultUpdatedSince6Years") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "PSU (Public Sector Undertaking)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          RadioGroup,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(RadioGroupItem, { value: "yes", id: "psu-yes" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "psu-yes", className: "font-normal cursor-pointer", children: "Yes" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(RadioGroupItem, { value: "no", id: "psu-no" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "psu-no", className: "font-normal cursor-pointer", children: "No" })
              ] })
            ]
          }
        ),
        getFieldError(errors, "psuOrNot") && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-destructive", children: getFieldError(errors, "psuOrNot") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "netNpaNbfc", children: "Net NPA (NBFC) (%)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "netNpaNbfc",
        ...
        getFieldError(errors, "netNpaNbfc") && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-destructive", children: getFieldError(errors, "netNpaNbfc") })
      ] })
    ] })
  ] }) });
}
...
function safeNum(value) {
  if (value === void 0 || value === null || Number.isNaN(value) || !Number.isFinite(value)) {
    return 0;
  }
  return value;
}
...
function calculateAllFormulas(inputs) {
  const {
    marketCap,
    ltp,
    pbRatio,
  ...
  const HValue = safeDivide(
    safeNum(initialGrowthValue) * 100,
    safeNum(revenueLastYear)
  );
  const H = {
    name: "H",
  ...
  const initialCapitalReturnYearlyValue = safeDivide(
    safeNum(DValue) * 100,
    REPO_RATE
  );
  const initialCapitalReturnYearly = {
  ...
  const initialCapitalReturnQuarterlyValue = safeDivide(
    safeNum(GValue) * 400,
    REPO_RATE
  );
  const initialCapitalReturnQuarterly = {
  ...
  const initialAverageCapitalReturnValue = (safeNum(initialCapitalReturnYearlyValue) + safeNum(initialCapitalReturnQuarterlyValue)) / 2;
  ...
  const initialCapitalReturnPlusAssetValue = safeNum(initialAverageCapitalReturnValue) + safeNum(bookValueValue);
  const initialCapitalReturnPlusAsset = {
  ...
  const totalMarketCapValue = safeNum(initialCapitalReturnPlusAssetValue) * safeNum(LValue) * safeNum(QValue) * safeNum(MValue) * safeNum(NValue) * safeNum(PValue);
  ...
  const actualValueValue = safeDivide(
    initialCapitalReturnPlusAssetValue,
    totalSharesValue
  );
  const actualValue = {
    name: "Actual Value",
...
function useCountUp({
  ...
  const [count2, setCount] = reactExports.useState(start);
...
function BuyTargetPriceCards({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-2 border-primary/30 bg-gradient-to-br from-primary/5 to-background relative overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 w-32 h-32 bg-primary/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "py-6 relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 bg-primary/10 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingDown, { className: "h-5 w-5 text-primary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-muted-foreground", children: "Buy price" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl font-bold text-primary", children: formatCurrency(buyPrice) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-2", children: "Lower valuation threshold" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-2 border-accent/30 bg-gradient-to-br from-accent/5 to-background relative overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 w-32 h-32 bg-accent/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "py-6 relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 bg-accent/10 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "h-5 w-5 text-accent" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-muted-foreground", children: "Target price" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl font-bold text-accent", children: formatCurrency(targetPrice) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-2", children: "Higher valuation threshold" })
        ] })
      ] })
    ] }),
    showWarning && warningMessage && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 text-xs text-amber-600 dark:text-amber-500 bg-amber-50 dark:bg-amber-950/20 p-3 rounded border border-amber-200 dark:border-amber-900/30", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-4 w-4 flex-shrink-0 mt-0.5" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: warningMessage })
    ] })
  ] });
}
function ResultsSection({ inputs }) {
  const [intrinsicValue, setIntrinsicValue] = reactExports.useState(null);
  const [actualValue, setActualValue] = reactExports.useState(null);
  const [calculating, setCalculating] = reactExports.useState(false);
  ...
  const buyPrice = hasCalculated && intrinsicValue !== null && actualValue !== null ? Math.min(animatedIntrinsic, animatedActual) : 0;
  const targetPrice = hasCalculated && intrinsicValue !== null && actualValue !== null ? Math.max(animatedIntrinsic, animatedActual) : 0;
  const showWarning = hasCalculated && (intrinsicValue === 0 || actualValue === 0);
  const warningMessage = showWarning ? intrinsicValue === 0 && actualValue === 0 ? "Both Buy price and Target price are zero. Please verify your input values." : intrinsicValue === 0 ? "Buy price is zero (Intrinsic Price calculation). Please verify your input values." : "Target price is zero (Actual Value calculation). Please verify your input values." : void 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold mb-2", children: "Company Information" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Calculate per-share metrics based on your company snapshot" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Value in Cr." })
    ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-semibold", children: "Calculate Buy & Target price" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs opacity-70", children: "Calculate both metrics" }),
            calculating && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-primary/10 animate-pulse" })
          ]
        }
      ),
      hasCalculated && /* @__PURE__ */ jsxRuntimeExports.jsx(
        BuyTargetPriceCards,
        {
          buyPrice,
          targetPrice,
    ...
    !hasCalculated && /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-dashed", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "py-12 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-12 w-12 mx-auto mb-4 text-muted-foreground/50" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Click the button above to calculate and reveal both output values" })
    ] }) })
  ] });
}
...
const EXAMPLE_INPUTS = {
  ...
  // 150B
  ltp: 150,
  revenueLastYear: 5e10,
  // 50B
  netProfitLastYear: 8e9,
  // 8B
  revenueLastQuarter: 13e9,
  // 13B
  netProfitLastQuarter: 21e8,
  // 2.1B
  pbRatio: 3.5,
  publicHolding: 0.65,
  // 65%
  promoterPledgeQuantity: 0.125,
  // 12.5%
  resultUpdatedSince6Years: true,
  psuOrNot: false,
  netNpaNbfc: 0.032
...
const VERIFICATION_INPUTS = {
  shareName: "Verification Test",
  marketCap: 1e11,
  // 100B
  ltp: 100,
  revenueLastYear: 4e10,
  // 40B
  netProfitLastYear: 6e9,
  // 6B
  revenueLastQuarter: 11e9,
  // 11B
  netProfitLastQuarter: 16e8,
  // 1.6B
  pbRatio: 3,
  publicHolding: 0.6,
  // 60%
  promoterPledgeQuantity: 0.1,
  // 10%
  resultUpdatedSince6Years: true,
  psuOrNot: false,
  netNpaNbfc: 0.025
...
function numbersMatch(calculated, expected, tolerance = TOLERANCE) {
  return Math.abs(calculated - expected) <= tolerance;
}
function round2(value) {
  return Math.round(value * 100) / 100;
}
function runDevCheck(inputs = VERIFICATION_INPUTS) {
  ...
  const intrinsicPass = numbersMatch(
    calcIntrinsic,
    EXPECTED_VALUES.intrinsicPrice
  );
  const actualPass = numbersMatch(calcActual, EXPECTED_VALUES.actualValue);
  const allPassed = intrinsicPass && actualPass;
  const details = {
    intrinsicPrice: {
      calculated: calcIntrinsic,
      expected: EXPECTED_VALUES.intrinsicPrice,
      passed: intrinsicPass
    },
    actualValue: {
      calculated: calcActual,
      expected: EXPECTED_VALUES.actualValue,
      passed: actualPass
    }
  };
  ...
  console.log(
    `  Intrinsic Price: ${calcIntrinsic} (expected: ${EXPECTED_VALUES.intrinsicPrice}) ${intrinsicPass ? "✅" : "❌"}`
  );
  console.log(
    `  Actual Value: ${calcActual} (expected: ${EXPECTED_VALUES.actualValue}) ${actualPass ? "✅" : "❌"}`
  );
  console.log(`
Overall: ${allPassed ? "✅ PASSED" : "❌ FAILED"}`);
  console.groupEnd();
  let message = allPassed ? "All calculations match expected values!" : "Some calculations do not match expected values. Check console for details.";
  if (!allPassed) {
    const failures = [];
    if (!intrinsicPass)
      failures.push(
        `Intrinsic Price: ${calcIntrinsic} ≠ ${EXPECTED_VALUES.intrinsicPrice}`
      );
    if (!actualPass)
      failures.push(
        `Actual Value: ${calcActual} ≠ ${EXPECTED_VALUES.actualValue}`
      );
    message += `
${failures.join(", ")}`;
  }
...
function parseInputsFromQuery(params) {
  const parsePercentValue = (paramValue, defaultValue) => {
    if (!paramValue) return defaultValue;
    const parsed = Number.parseFloat(paramValue);
    if (Number.isNaN(parsed)) return defaultValue;
    return parsed > 1 ? parsed / 100 : parsed;
  };
  const parseBooleanValue = (paramName, defaultValue) => {
...
function App() {
  ...
  const errors = reactExports.useMemo(() => validateInputs(inputs), [inputs]);
  const [contactForm, setContactForm] = reactExports.useState({
    name: "",
    email: "",
    message: ""
  });
  const [contactSubmitting, setContactSubmitting] = reactExports.useState(false);
  ...
  const handleRunDevCheck = () => {
    ...
    setTimeout(() => {
      ...
      if (result.passed) {
        ue.success("Dev Check Passed! ✅", {
          description: result.message,
          duration: 5e3
        });
      } else {
        ue.error("Dev Check Failed ❌", {
          description: result.message,
          duration: 5e3
        });
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "border-b bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 bg-primary/10 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Calculator, { className: "h-6 w-6 text-primary" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold", children: "Intri" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Track and analyze company financial metrics" })
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "container mx-auto px-4 py-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto space-y-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CompanyInfoDisplay, { inputs }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold mb-4", children: "Company Snapshot" }),
          errors.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 p-4 bg-destructive/10 border border-destructive/20 rounded-lg", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-destructive", children: "Please fix the following errors:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-2 text-sm text-destructive list-disc list-inside", children: errors.map((error) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: error.message }, error.message)) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            DcfInputsForm,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(ResultsSection, { inputs }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("section", { "data-ocid": "contact.section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "text-center pb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 bg-primary/10 rounded-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-6 w-6 text-primary" }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-2xl font-bold", children: "Contact Us" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { className: "text-base", children: "Have questions or feedback? We'd love to hear from you." })
          ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t mt-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row justify-between items-center gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiX, { className: "h-5 w-5" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            ...
            rel: "noopener noreferrer",
            className: "text-muted-foreground hover:text-foreground transition-colors",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiLinkedin, { className: "h-5 w-5" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            ...
            rel: "noopener noreferrer",
            className: "text-muted-foreground hover:text-foreground transition-colors",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiGithub, { className: "h-5 w-5" })
          }
        )
      ] })
    ] }) }) }),
...
const DcfInputs = Record({
  "weightedAveCostOfCapital": Float64,
  "sharesOutstanding": Float64,
  "forecastedFCF": Float64,
  "terminalYears": Int,
  "actualSharePrice": Float64,
  "revenueLastYear": Float64,
  "revenueLastQuarter": Float64,
  "perpetualGrowthRate": Float64
});
const DcfOutputs = Record({
  "totalMarketCap": Float64,
  "intrinsicPricePerShare": Float64,
  "adjustedValuation": Float64,
  "actualPerShare": Float64,
...
Service({
  ...
  "getNumAllUserProfiles": Func([], [Opt(Nat)], ["query"]),
  "getUserProfile": Func(
    [Principal2],
    [Opt(UserProfile)],
    ["query"]
  ...
  "processDcf": Func([DcfInputs], [DcfOutputs], ["query"]),
